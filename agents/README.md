...
| `statistician/` | Statistician | Validates every inference; experiment analysis; sample-ratio-mismatch detection and novelty-effect checks; ship / no-ship verdicts | Cannot override an L1 veto — must document it, not argue with it |
